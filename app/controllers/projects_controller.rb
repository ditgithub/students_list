class ProjectsController < ApplicationController
  ...
  before_action :student_admin_loggedin?, only: [:create, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        Notifier.alert_admin(@project).deliver
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:project_name, :project_description_name, :start_date, :end_date, :student_id)
    end
end
